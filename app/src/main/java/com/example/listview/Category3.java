...
public class Category3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Book> listAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, Book.books3);
        ...
        AdapterView.OnItemClickListener itemClickListener =
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> listBooks, View view, int position, long id) {
                        Intent intent = new Intent(Category3.this, BookCategory3.class);
